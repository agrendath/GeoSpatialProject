...
def index():
    ...
    #standstill_position = {'station': 'Dendermonde', 'destination': 'Dendermonde', 'vehicle_name': 'S3 2266', 'departure_time': '17:50', 'composition': {'facilities': ['airconditioning', 'heating'], 'occupancy': 'low', 'carriages_count': 6, 'carriages': [{'carriage_type': 'left-wagon', 'model': 'AM08M_c', 'classes': [1, 2], 'facilities': ['accessible_toilet', 'toilet', 'bike'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'AM08M_b', 'classes': [2], 'facilities': [], 'carriage_size': 18.4}, {'carriage_type': 'middle-wagon', 'model': 'AM08M_a', 'classes': [1, 2], 'facilities': [], 'carriage_size': 18.4}, {'carriage_type': 'middle-wagon', 'model': 'AM08M_c', 'classes': [1, 2], 'facilities': ['accessible_toilet', 'toilet', 'bike'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'AM08M_b', 'classes': [2], 'facilities': [], 'carriage_size': 18.4}, {'carriage_type': 'middle-wagon', 'model': 'AM08M_a', 'classes': [1, 2], 'facilities': [], 'carriage_size': 18.4}]}, 'next_destination': 'Liège-Guillemins', 'next_vehicle_name': 'P 8446', 'next_departure_time': '18:02', 'next_composition': {'facilities': ['airconditioning', 'heating'], 'occupancy': 'low', 'carriages_count': 12, 'carriages': [{'carriage_type': 'loco', 'model': 'HLE18', 'classes': [], 'facilities': [], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11BUH', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11BUH', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11AUH', 'classes': [1], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I10BUH', 'classes': [2], 'facilities': ['toilet', 'bike'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11BUH', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11BUH', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11BUH', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I6AUH', 'classes': [1], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11BUH', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'I11BUH', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': 'loco', 'model': 'HLE18', 'classes': [], 'facilities': [], 'carriage_size': 18.4}]}, 'standstill_position': {'track': '1', 'ref': '6', 'lat': Decimal('50.8610602'), 'lon': Decimal('4.3614324')}, 'zone_markers': [{'track': '1', 'ref': '1B', 'lat': Decimal('50.8595626'), 'lon': Decimal('4.3607387')}, {'track': '1', 'ref': '1B', 'lat': Decimal('50.8601953'), 'lon': Decimal('4.3610195')}, {'track': '1', 'ref': '1A', 'lat': Decimal('50.8615729'), 'lon': Decimal('4.3616348')}, {'track': '1', 'ref': '1A', 'lat': Decimal('50.8609263'), 'lon': Decimal('4.3613439')}], 'departure': {'id': '9', 'station': 'Dendermonde', 'stationinfo': {'@id': 'http://irail.be/stations/NMBS/008893401', 'id': 'BE.NMBS.008893401', 'name': 'Dendermonde', 'locationX': '4.101427', 'locationY': '51.022781', 'standardname': 'Dendermonde'}, 'time': '1715701800', 'delay': '0', 'canceled': '0', 'left': '0', 'isExtra': '0', 'vehicle': 'BE.NMBS.S32266', 'vehicleinfo': {'name': 'BE.NMBS.S32266', 'shortname': 'S3 2266', 'number': '2266', 'type': 'S3', 'locationX': '0', 'locationY': '0', '@id': 'http://irail.be/vehicle/S32266'}, 'platform': '1', 'platforminfo': {'name': '1', 'normal': '1'}, 'occupancy': {'@id': 'http://api.irail.be/terms/unknown', 'name': 'unknown'}, 'departureConnection': 'http://irail.be/connections/8812005/20240514/S32266'}}
    #standstill_position = {'station': 'Brussels-South/Brussels-Midi', 'destination': 'Brussels-South/Brussels-Midi', 'vehicle_name': 'IC 9256', 'departure_time': '20:08', 'composition': {'facilities': [], 'occupancy': 'low', 'carriages_count': 0, 'carriages': []}, 'next_destination': 'Kortrijk', 'next_vehicle_name': 'IC 2343', 'next_departure_time': '20:27', 'next_composition': {'facilities': ['airconditioning', 'heating'], 'occupancy': 'low', 'carriages_count': 10, 'carriages': [{'carriage_type': 'loco', 'model': 'HLE18', 'classes': [], 'facilities': [], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BU', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BU', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BU', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6AU', 'classes': [1], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BDUH', 'classes': [2], 'facilities': ['accessible_toilet', 'toilet', 'bike', 'luggage_lockers'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BU', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BU', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BU', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}, {'carriage_type': '', 'model': 'M6BXCT', 'classes': [2], 'facilities': ['toilet'], 'carriage_size': 18.4}]}, 'standstill_position': None, 'zone_markers': [{'track': '9', 'ref': '9B', 'lat': Decimal('50.8594190'), 'lon': Decimal('4.3615467')}, {'track': '9', 'ref': '9B', 'lat': Decimal('50.8600429'), 'lon': Decimal('4.3618283')}, {'track': '9', 'ref': '9A', 'lat': Decimal('50.8607746'), 'lon': Decimal('4.3621587')}, {'track': '9', 'ref': '9A', 'lat': Decimal('50.8614218'), 'lon': Decimal('4.3624493')}], 'departure': {'id': '5', 'station': 'Brussels-South/Brussels-Midi', 'stationinfo': {'@id': 'http://irail.be/stations/NMBS/008814001', 'id': 'BE.NMBS.008814001', 'name': 'Brussels-South/Brussels-Midi', 'locationX': '4.336531', 'locationY': '50.835707', 'standardname': 'Brussel-Zuid/Bruxelles-Midi'}, 'time': '1715710080', 'delay': '480', 'canceled': '0', 'left': '0', 'isExtra': '0', 'vehicle': 'BE.NMBS.IC9256', 'vehicleinfo': {'name': 'BE.NMBS.IC9256', 'shortname': 'IC 9256', 'number': '9256', 'type': 'IC', 'locationX': '0', 'locationY': '0', '@id': 'http://irail.be/vehicle/IC9256'}, 'platform': '9', 'platforminfo': {'name': '9', 'normal': '1'}, 'occupancy': {'@id': 'http://api.irail.be/terms/unknown', 'name': 'unknown'}, 'departureConnection': 'http://irail.be/connections/8812005/20240514/IC9256'}}
